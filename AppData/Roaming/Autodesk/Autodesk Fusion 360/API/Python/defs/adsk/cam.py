...
class CAMManager(core.Base):
    ...
    def networkMachineIntegrationManager(self) -> NetworkMachineIntegrationManager:
        ...
        integrate add-ins into the 'Find network machines' dialog, which enables users to add
...
class OperationBase(core.Base):
    ...
    def strategy(self) -> str:
        """
        Gets the name of the toolpath strategy associated with this operation.
        """
        return str()
    @property
    ...
    def hasErrors(self) -> bool:
        """
        Gets if errors were encountered when generating the toolpath for this operation.
        """
        return bool()
    @property
    def error(self) -> str:
...
class CAMHoleRecognition(OperationBase):
    ...
    def allOperations(self) -> core.ObjectCollection:
        """
        Gets a collection containing all of the operations in this hole recognition.
        This includes all operations nested in folders and patterns.
        """
        return core.ObjectCollection()
...
class Setup(OperationBase):
    ...
    def fixtures(self) -> core.ObjectCollection:
        ...
        To be abel to set models as fixtures, the fixturesEnabled property has to be set first.
        """
        return core.ObjectCollection()
    @fixtures.setter
    ...
    def stockSolids(self) -> core.ObjectCollection:
        """
        Gets and sets the stock solids associated with the setup. StockMode has to be set to `SolidStock` otherwise this wil throw an error.
        """
        return core.ObjectCollection()
    @stockSolids.setter
    ...
    def machine(self) -> Machine:
        """
        Gets and sets the Machine associated with the setup.  Getting the Machine will return a
        copy, so any modifications to it need to be followed by setting the Machine again afterwards.
        Note:
        At the moment it is not possible to set an additive machine.
        """
        return Machine()
    @machine.setter
    def machine(self, value: Machine):
        ...
        pass
    @property
    def stockMode(self) -> SetupStockMode:
        """
        ...
        """
        return SetupStockMode()
    @stockMode.setter
    def stockMode(self, value: SetupStockMode):
        """
        Gets and sets the bodies associated with the setup.  Passing in an empty ObjectCollection
        will remove all current bodies.  Valid input is MeshBody and/or BRepBody objects.
        """
